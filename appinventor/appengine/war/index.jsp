...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Chakra+Petch:ital,wght@0,400;0,500;0,600;0,700;1,700&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap" rel="stylesheet">
    <% if (!gatag.isEmpty()) { %>
    <!-- Google Analytics. -->
    <!-- Google tag (gtag.js) -->
...
<% } %>
    ...
    <link type="text/css" rel="stylesheet" href="/static/css/polycrest-theme.css">
    <noscript>
      <div class="floatingBox">
        <h2> PolyCrest App Studio needs JavaScript enabled to run.</h2>
      </div>
    </noscript>
  ...
  <body class="gwt-bodyRob">
    <div class="floatingBox" style="display:none" id="unsupported">
      ...
      To use PolyCrest App Studio, you must use a compatible browser.<br>
