...
public final class PropertyHelpWidget extends Image {
  ...
  private class PropertyHelpPopup extends DialogBox {
    ...
    private PropertyHelpPopup(final EditableProperty prop,
      ...
      setPopupPositionAndShow(new com.google.appinventor.client.utils.PZAwarePositionCallback(PropertyHelpWidget.this.getElement()) {
        @Override
        public void setPosition(int offsetWidth, int offsetHeight) {
          int left = getTrueAbsoluteLeft();
          int top = getTrueAbsoluteTop() + PropertyHelpWidget.this.getOffsetHeight() + 4;
          ...
          if (left + offsetWidth > windowWidth - 16) {
            left = windowWidth - offsetWidth - 16;
          }
          if (left < 16) {
            left = 16;
          }
          if (top + offsetHeight > windowHeight - 16) {
            top = Math.max(16, getTrueAbsoluteTop() - offsetHeight - 4);
          }
