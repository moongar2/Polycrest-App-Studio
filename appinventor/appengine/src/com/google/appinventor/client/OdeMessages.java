...
public interface OdeMessages extends Messages, ComponentTranslations {
  ...
  @DefaultMessage("An Email from PolyCrest App Studio Gallery")
  @Description("Title of the email when moderator sends out an email")
  String moderationSendEmailTitle();

  @DefaultMessage("PolyCrest Gallery: App Activated")
  ...
  @DefaultMessage("PolyCrest Gallery: App Deactivated")
  ...
  @DefaultMessage("PolyCrest App Studio")
  ...
  @DefaultMessage("The project \"{0}\" contains an invalid extension. PolyCrest App Studio will attempt to continue.")
  ...
  @DefaultMessage("Get Companion & PCstarter...")
  @Description("Information and downloads for the Companion and PCstarter")
  ...
  @DefaultMessage("WARNING: The number of screens in this app might exceed the limits of PolyCrest App Studio. " +
  ...
  @DefaultMessage("The build server is not compatible with this version of PolyCrest App Studio.")
  @Description("Error message reported when the build server is running a different version of " +
      "the PolyCrest App Studio code.")
  ...
  //Ode.java messages
  @DefaultMessage("Welcome to PolyCrest App Studio!")
  @Description("")
  String createNoProjectsDialogText();

  @DefaultMessage("You do not have any projects in PolyCrest App Studio. " +
      "To learn how to use the studio, click the \"Guide\" " +
  ...
  @DefaultMessage("<h2>Please fill out a short voluntary survey so that we can learn more about our creators and improve PolyCrest App Studio.</h2>")
  @Description("")
  ...
  @DefaultMessage("<p><font color=red>Warning:</font> This session is out of date.</p>" +
                "<p>This PolyCrest account has been opened from another location. " +
  ...
  @DefaultMessage("<p><font color=red>WARNING:</font> A second PolyCrest " +
                "session has been opened for this account. You may choose to " +
                "continue with both sessions, but working with PolyCrest App Studio from more " +
                "than one session simultaneously can cause blocks to be lost in ways " +
                "that cannot be recovered from the PolyCrest server.</p><p>" +
                "We recommend that creators not open multiple sessions on the same " +
                ...
                "have a backup copy independent of the server. Use " +
